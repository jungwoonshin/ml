...
for t = 1:m,
    ...
    temp_y = zeros(num_labels,1);  % 10 * 1
    temp_y(y(t))= 1; % 10 * 1
    delta3t = ht - temp_y; % 10 * 1

    z2t = [1; Theta1 * a1t]; % 26*1/
    delta2t = Theta2' * delta3t .* sigmoidGradient(z2t); % 26*1

    delta1 = delta1 + delta2t(2:end) * a1t'; % 25 * 401
    delta2 = delta2 + delta3t * a2t'; % 10 * 26
end;
